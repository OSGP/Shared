...
public class EventNotification implements Serializable {
    ...
    public EventNotification(final String deviceUid, final DateTime dateTime, final EventType eventType,
    ...
    public String toString() {
        return String.format("EventNotification[deviceUid=%s, dateTime=%s, eventType=%s, index=%s, description=%s]",
