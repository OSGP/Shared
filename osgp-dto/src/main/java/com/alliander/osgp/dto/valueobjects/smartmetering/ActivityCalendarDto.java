...
public class ActivityCalendarDto implements Comparable<ActivityCalendarDto>, Serializable {
    ...
    public ActivityCalendarDto(final String calendarName, final CosemDateTimeDto activatePassiveCalendarTime,
        ...
        this.seasonProfileList = new ArrayList<SeasonProfileDto>(seasonProfileList);
